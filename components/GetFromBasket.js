    ...
    return (
        <View style={{ backgroundColor: '#faf3dd', width: '100%', height: '100%' }}>
            <View style={{ width: '100%', height: 150, backgroundColor: '#FFBF58', borderBottomLeftRadius: 40, borderBottomRightRadius: 40 }}>
                <TouchableOpacity onPress={() => navigation.navigate('BuyScreen')} style={{ width: '20%', height: '20%' }}>
                    <Text style={{ height: '160%', width: '120%', marginTop: '110%', fontSize: 20, marginLeft: '120%', backgroundColor: 'white', textAlign: 'center', borderRadius: 10 }}>Add to Basket</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ width: '20%', height: '20%' }}>
                    <Text style={{ height: '168%', width: '120%', marginTop: '72%', fontSize: 20, marginLeft: '300%', backgroundColor: '#BB342F', textAlign: 'center', borderRadius: 10, alignItems: 'center' }}>Get from Basket</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={{ bottom: '-0%', position: 'absolute', width: '100%', height: 100, backgroundColor: '#FFBF58', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
