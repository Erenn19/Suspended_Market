    ...
    return (
        <View>
            <View style={{ width: '20%', height: '40%' }}>
                ...
                <View style={{ margin: 200, marginLeft: '250%', alignItems: 'center', justifyContent: 'center' }}>
                    <Image source={require('../images/Illustration1.png')} />
                </View>
            </View>
            <View style={{ width: '100%', height: '100%', marginTop: 20 }} >
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ fontSize: 25, color: '#101621', marginLeft: -10, fontWeight: 'bold', marginTop: '3%' }}>Fill the Form</Text>
                </View>
